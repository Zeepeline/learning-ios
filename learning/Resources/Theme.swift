...
extension Color {
    ...
    /// Inisialisasi Color dari Hex string (misal: "#FFD166" atau "FFD166")
    init(hex: String) {
...
// MARK: - 🔘 Reusable Button Style (Tekan Kartun Tactile)
struct CartoonPressButtonStyle: ButtonStyle {
    var pressOffset: CGFloat = 1.0
