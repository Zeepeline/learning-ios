...
// AppTrackingView: helper methods kept here — its body reads private member(s): actionButtonsCard, heroHeaderCard, idfaDetailCard, privacyEducationalCard, statusOverviewCard.
...
extension AppTrackingView {
    ...
    @MainActor func __patchSlots() -> [String: ([String]) -> AnyView] {
        ...
        __s["op_4ed24b3f4cb7b8f6"] = { (_: [String]) in AnyView(VStack(spacing: HIGSpacing.md) {
                // 1. 🎯 Sticker Badge & Hero Card
                heroHeaderCard
    ...
    @MainActor func __patchTokens() -> [String: PatchHostToken] {
        ...
        __t["ct_41c48ef0f2a80988"] = .color(Color.cartoonMint)
        return __t
    }
