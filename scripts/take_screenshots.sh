#!/bin/bash
# ==============================================================================
# Script Otomatis Snapshot Screenshot Simulator untuk README.md
# ==============================================================================
...
if [ -z "$BOOTED_DEVICE" ]; then
    echo "⚠️ Tidak ada Simulator yang aktif. Mencari iPhone 16 / iPhone 15..."
...
echo "✅ Menggunakan Simulator: $DEVICE_NAME ($BOOTED_DEVICE)"

echo ""
echo "================================================================="
echo "📸 PANDUAN CEPAT PENGAMBILAN SCREENSHOT:"
echo "1. Buka halaman yang diinginkan di Simulator."
echo "2. Jalankan opsi nomor di bawah untuk menjepret langsung ke folder docs/screenshots/"
echo "================================================================="
echo ""
...
capture() {
    ...
    echo "📸 Mengambil screenshot untuk: $desc..."
    xcrun simctl io "$BOOTED_DEVICE" screenshot "$path"
